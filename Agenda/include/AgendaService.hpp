...
public:
  ...
  */
  bool updateUser(const std::string userName, const std::string password,
                  const std::string email, const std::string phone);

  /**
  * find user's password
  */
  bool findPassword(const std::string userName, const std::string email,
                    const std::string phone);

  /**
  * remind meeting's participators
  */
  void remindParticipator(const std::vector<std::string> participator,
                          const std::string remind);

  /**
  * show user's remind
  */
  void showRemind(std::string userName);
...
class myException {
public:
  myException(std::string s) { errorcode = s; }
  std::string what() { return errorcode; }
