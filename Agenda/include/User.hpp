...
public:
  ...
  */
  User(std::string t_userName, std::string t_userPassword,
    std::string t_userEmail, std::string t_userPhone, std::string t_userRemind);
  ...
  */
  ...
  /**
  * @breif set the remind information
  * @param a string indicate the remind information
  */
  void setRemind(std::string t_remind) { m_remind = t_remind; }

  std::string getRemind() const { return m_remind; }
